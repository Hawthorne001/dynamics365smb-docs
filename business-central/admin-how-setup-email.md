...
When you create your app registration, note the following information. You need it to connect [!INCLUDE[prod_short](includes/prod_short.md)] to your app registration.
