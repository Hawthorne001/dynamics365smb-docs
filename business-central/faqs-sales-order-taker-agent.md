...
- Emailing
  ...
  - The agent processes the email body and any PDF or image files attached to emails to get the details of the request. PDF attachments must contain a maximum of 10 pages. Attachments with more than 10 pages aren't fully processed.
