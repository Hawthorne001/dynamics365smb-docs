...
![Shows the icon for chat with Copilot pane with callouts](media/BC_AI_banner.png)

X2

![Shows the icon for chat with Copilot pane with callouts](media/BC_AI_banner_X2.png)
...
### [Simplifying company setup](#tab/companysetup)
